...
public interface ProductChartService {
    ProductsChartResponse getProductsChart(ReportChartRequest request);
    ProductChartResponse getProductChartByProductId(String productId, ReportChartRequest request);
}
