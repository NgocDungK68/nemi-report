...
public interface AdsManagerClient {
    ...
    @PostMapping("service-api/v1/ad-cost-of-products")
    public ResponseEntity<AdsCostOfProductsResponse> getAdsCostOfProducts(@RequestBody AdsCostOfProductsRequest request);
}
